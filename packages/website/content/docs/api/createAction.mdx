...
Please ensure the file is annotated with the 'use server' directive. All exports within this file will be transformed into publicly facing endpoints. This action can be imported into any React application that supports server actions.

## API

#### `createAction()`

Creates a new action creator instance.
